  ...
  return (
    <>
      <InnerHero
        ...
        image="/images/istanbul-maslak.png"
          ...
          <CardShell className="p-6">
            ...
            <div className="mt-6 space-y-4 text-sm leading-7 text-slate-700">
              <p className="flex gap-3">
                <MapPin aria-hidden="true" className="mt-1 h-5 w-5 shrink-0 text-[#2437d6]" />
                {dict.contactPage.details[0]}
              </p>
              <a href={getWhatsAppUrl()} target="_blank" rel="noreferrer" className="flex gap-3 font-semibold text-[#2437d6]">
              ...
              <a href={`mailto:${dict.site.email}`} className="flex gap-3 font-semibold text-slate-800">
                <Mail aria-hidden="true" className="mt-1 h-5 w-5 shrink-0 text-[#2437d6]" />
